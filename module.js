M.block_prettymycourses = {}
/*
M.block_prettymycourses.add_handles = function(Y) {
    M.block_prettymycourses.Y = Y;
    var MOVEICON = {
        pix: "i/move_2d",
        component: 'moodle'
    };
    ...
    YUI().use('dd-constrain', 'dd-proxy', 'dd-drop', 'dd-plugin', function(Y) {
        ...
        Y.DD.DDM.on('drag:start', function(e) {
            ...
            drag.get('dragNode').addClass('block_prettymycourses');
        ...
        Y.DD.DDM.on('drag:end', function(e) {
            ...
            M.block_prettymycourses.save(Y);
        });
...
M.block_prettymycourses.save = function() {
    var Y = M.block_prettymycourses.Y;
    ...
    Y.io(M.cfg.wwwroot+'/blocks/prettymycourses/save.php', {
        method: 'POST',
 ...
 */
/*
M.block_prettymycourses.collapsible = function(Y, id, userpref, strtooltip) {
    if (userpref) {
        M.block_prettymycourses.userpref = true;
    }
    Y.use('anim', function(Y) {
        new M.block_prettymycourses.CollapsibleRegion(Y, id, userpref, strtooltip);
    });
};
*/
 ...
 */
/*
M.block_prettymycourses.CollapsibleRegion = function(Y, id, userpref, strtooltip) {
...
/*
M.block_prettymycourses.userpref = false;
*/
 ...
 */
/*
M.block_prettymycourses.CollapsibleRegion.prototype.userpref = null;
*/
/**
 ...
 */
/*
M.block_prettymycourses.CollapsibleRegion.prototype.div = null;
*/
/**
 * The key divs that make up this
 * @property icon
 ...
 */
/*
M.block_prettymycourses.CollapsibleRegion.prototype.icon = null;
*/
